<x-layouts.site :title="'Products - Sumatera Interior'">
    <section class="page-section">
        <div class="page-header">
            ...
            <p class="page-subtitle">Kategori produk dikelompokkan sesuai kebutuhan CURTAIN, BLINDS, RAILING, HOOK, dan MOTORIZED.</p>
        ...
        <section class="surface-card mb-8 p-6 lg:p-7">
