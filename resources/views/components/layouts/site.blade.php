...
<body class="zoom-bg text-slate-900 antialiased">
    <header class="sticky top-0 z-50 border-b border-sky-100/80 bg-white/90 backdrop-blur">
        <nav class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 text-sm font-semibold text-slate-700 sm:gap-6">
                ...
                <a href="{{ route('about') }}" class="hover:text-sky-700">About</a>
                <a href="#contact-footer" class="hover:text-sky-700">Contact</a>
            </div>
        </nav>
    </header>
    ...
    <footer id="contact-footer" class="border-t border-sky-100 bg-white/80">
        ...
        <div class="lg:text-center text-xs text-slate-600 py-4 border-t border-sky-100">
